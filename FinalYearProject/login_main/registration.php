...
<html lang="en">
<head>
	<title>IMCHA Registration</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<!-- Login Form Stars here -->
				<form name= "sentMessage" id ="loginForm" method="POST" action="registration.php" class="login100-form validate-form">
					<span class="login100-form-title">
						USER Registration
					</span>
					<p><?php include('../errors.php'); ?></p>
						
					<div class="wrap-input100 validate-input" data-validate = "Please enter a valid Name">
					...
					<div class="container-login100-form-btn">
						<button type="submit" value="Log In" name="submit-btn" class="login100-form-btn">
							Register
						</button>
						<p><a style="color:white;" href="login_main.php">Go to Login!</a></p>
					</div>
